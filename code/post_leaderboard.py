...
rank = 0
comment = f"🫣Teaser time🫣 the \"All Time Leaderboard\" will be ready soon..  \r\n" \
...
comment += f"\r\nThis day is defined starting at {yesterday.date()} 00:00 UTC and ending at {datetime.datetime.now().date()} 00:00 UTC.  \r\n" \
           f"The code generating this leaderboard is available for review here:  \r\n" \
           f"`https://github.com/birdwastheword/Coneheads-Tip-Leaderboard`"
